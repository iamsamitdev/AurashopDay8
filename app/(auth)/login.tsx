import { Dimensions, ScrollView, Image, KeyboardAvoidingView, Platform, SafeAreaView } from 'react-native'
        ...
        <ScrollView contentContainerStyle={{height: '100%'}}>
          ...
          >
            ...
            <View className="flex justify-center pt-5 flex-row gap-2">
              ...
              <Button title={t('auth.login.registerButton')} onPress={() => router.replace('/register')} />
            </View>
          </View>
        </ScrollView>
      </KeyboardAvoidingView>
